...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'edff6da27c8942b3afa1a669313f516c',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'DerekSun', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://doc.xiaoayu.ren', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '笔记, 文档', // 网站关键词 英文逗号隔开
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/Note.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  WIDGET_PET_LINK:
        ...
        'https://raw.gitmirror.com/imuncle/live2d/master/model/penchan/penchan.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
